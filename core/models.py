...
class AuditLog(models.Model):
    ...
    ACTION_CHOICES = [
        ...
        ('case_held', 'Case Placed on Hold'),
        ('case_resumed', 'Case Resumed'),
        ('case_tier_changed', 'Case Tier Changed'),
        ...
        ('quarterly_credit_reset', 'Quarterly Credit Reset'),
        ('bulk_credit_reset', 'Bulk Credit Reset'),
        ...
        ('member_comment_added', 'Member Comment Added'),
        ('member_updates_viewed', 'Member Updates Viewed'),
        ...
        ('admin_ownership', 'Admin Took Ownership'),
        ('case_completed', 'Case Completed'),
        ('case_incomplete', 'Case Marked Incomplete'),
        ('case_rejected', 'Case Rejected'),
        ('case_cancelled', 'Case Canceled'),
        ('case_declined', 'Case Declined by ProFeds'),
        ('case_rush_downgraded', 'Rush Downgraded to Standard'),
