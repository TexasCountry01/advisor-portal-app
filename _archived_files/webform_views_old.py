    ...
    if request.method == 'POST':
        ...
        fact_finder_data = {
            'basic_information': {
                ...
                'date_of_birth': request.POST.get('date_of_birth', ''),  # Alternate field name
                ...
                'spouse_income': request.POST.get('spouse_income', ''),
                'address': request.POST.get('address', ''),
                'city': request.POST.get('city', ''),
                'state': request.POST.get('state', ''),
                'zip': request.POST.get('zip', ''),
                'children_ages': request.POST.get('children_ages', ''),
                'workshop_code': request.POST.get('workshop_code', ''),
                'urgency': request.POST.get('urgency', 'normal'),
                'requested_due_date': request.POST.get('requested_due_date', ''),
                'num_reports_requested': request.POST.get('num_reports_requested', '1'),
            },
            'retirement_system': {
            ...
            'retirement_pay_leave': {
                ...
                'service_computation_date': request.POST.get('service_computation_date', ''),  # Alternate field name
                ...
                'retirement_by_age': request.POST.get('retirement_by_age') == 'on',
                'retirement_by_date': request.POST.get('retirement_by_date') == 'on',
                'retirement_fully_eligible': request.POST.get('retirement_fully_eligible') == 'on',
                'retirement_mra_10': request.POST.get('retirement_mra_10') == 'on',
                'years_of_service': request.POST.get('years_of_service', ''),
                'notes': request.POST.get('retirement_pay_leave_notes', ''),
            },
            'employment_history': {
            ...
            'pay_information': {
                ...
                'expects_highest_three': request.POST.get('expects_highest_three', ''),
            },
            'leave_balances': {
                'annual_leave_hours': float(request.POST.get('annual_leave_hours', 0) or 0),
                'annual_leave_balance': float(request.POST.get('annual_leave_balance', 0) or 0),
                'sick_leave_hours': float(request.POST.get('sick_leave_hours', 0) or 0),
                'sick_leave_balance': float(request.POST.get('sick_leave_balance', 0) or 0),
            ...
            'tsp': {
                ...
                'agency_match_pct': float(request.POST.get('tsp_agency_match_pct', 0) or 0),
                ...
                # Additional TSP fields for PDF
                'use_income': request.POST.get('tsp_use_income') == 'on',
                'use_fun_money': request.POST.get('tsp_use_fun_money') == 'on',
                'use_legacy': request.POST.get('tsp_use_legacy') == 'on',
                'use_other': request.POST.get('tsp_use_other') == 'on',
                'retirement_goal': request.POST.get('tsp_retirement_goal', ''),
                'amount_needed': request.POST.get('tsp_amount_needed', ''),
                'need_asap': request.POST.get('tsp_need_asap') == 'on',
                'need_at_age': request.POST.get('tsp_need_at_age') == 'on',
                'need_age': request.POST.get('tsp_need_age', ''),
                'need_unsure': request.POST.get('tsp_need_unsure') == 'on',
                'sole_source': 'Yes' if request.POST.get('tsp_sole_yes') else ('No' if request.POST.get('tsp_sole_no') else ''),
                'sole_source_explain': request.POST.get('tsp_sole_source_explain', ''),
                'plan_leave': request.POST.get('tsp_plan_leave') == 'on',
                'plan_rollover': request.POST.get('tsp_plan_rollover') == 'on',
                'plan_unsure': request.POST.get('tsp_plan_unsure') == 'on',
                'in_service_withdrawal': 'Yes' if request.POST.get('tsp_withdrawal_yes') else ('No' if request.POST.get('tsp_withdrawal_no') else ''),
                'withdrawal_hardship': request.POST.get('tsp_withdrawal_hardship') == 'on',
                'withdrawal_age_based': request.POST.get('tsp_withdrawal_age_based') == 'on',
                'traditional_contribution': request.POST.get('tsp_traditional_contribution', ''),
                'roth_contribution': request.POST.get('tsp_roth_contribution', ''),
                'best_outcome': request.POST.get('tsp_best_outcome', ''),
                'worst_outcome': request.POST.get('tsp_worst_outcome', ''),
                'comments': request.POST.get('tsp_comments', ''),
                # TSP fund allocations and balances
                ...
                'f_fund_allocation': float(request.POST.get('tsp_f_fund_allocation', 0) or 0),
                'f_fund_balance': float(request.POST.get('tsp_f_fund_balance', 0) or 0),
                'c_fund_allocation': float(request.POST.get('tsp_c_fund_allocation', 0) or 0),
                'c_fund_balance': float(request.POST.get('tsp_c_fund_balance', 0) or 0),
                's_fund_allocation': float(request.POST.get('tsp_s_fund_allocation', 0) or 0),
                's_fund_balance': float(request.POST.get('tsp_s_fund_balance', 0) or 0),
                'i_fund_allocation': float(request.POST.get('tsp_i_fund_allocation', 0) or 0),
                'i_fund_balance': float(request.POST.get('tsp_i_fund_balance', 0) or 0),
                'l_income_allocation': float(request.POST.get('tsp_l_income_allocation', 0) or 0),
                'l_income_balance': float(request.POST.get('tsp_l_income_balance', 0) or 0),
                ...
                'l_2030_allocation': float(request.POST.get('tsp_l_2030_allocation', 0) or 0),
                'l_2030_balance': float(request.POST.get('tsp_l_2030_balance', 0) or 0),
                'l_2035_allocation': float(request.POST.get('tsp_l_2035_allocation', 0) or 0),
                'l_2035_balance': float(request.POST.get('tsp_l_2035_balance', 0) or 0),
                'l_2040_allocation': float(request.POST.get('tsp_l_2040_allocation', 0) or 0),
                'l_2040_balance': float(request.POST.get('tsp_l_2040_balance', 0) or 0),
                'l_2045_allocation': float(request.POST.get('tsp_l_2045_allocation', 0) or 0),
                'l_2045_balance': float(request.POST.get('tsp_l_2045_balance', 0) or 0),
                'l_2050_allocation': float(request.POST.get('tsp_l_2050_allocation', 0) or 0),
                'l_2050_balance': float(request.POST.get('tsp_l_2050_balance', 0) or 0),
                'l_2055_allocation': float(request.POST.get('tsp_l_2055_allocation', 0) or 0),
                'l_2055_balance': float(request.POST.get('tsp_l_2055_balance', 0) or 0),
                'l_2060_allocation': float(request.POST.get('tsp_l_2060_allocation', 0) or 0),
                'l_2060_balance': float(request.POST.get('tsp_l_2060_balance', 0) or 0),
                'l_2065_allocation': float(request.POST.get('tsp_l_2065_allocation', 0) or 0),
                ...
                'general_loan_date': request.POST.get('tsp_general_loan_date', ''),
                'general_loan_payoff': request.POST.get('tsp_general_loan_payoff', ''),
                'general_loan_repayment': float(request.POST.get('tsp_general_loan_repayment', 0) or 0),
                'residential_loan_balance': float(request.POST.get('tsp_residential_loan_balance', 0) or 0),
                'residential_loan_date': request.POST.get('tsp_residential_loan_date', ''),
                'residential_loan_payoff': request.POST.get('tsp_residential_loan_payoff', ''),
                'residential_loan_repayment': float(request.POST.get('tsp_residential_loan_repayment', 0) or 0),
                # Risk tolerance
                ...
                'risk_tolerance_why': request.POST.get('tsp_risk_tolerance_why', ''),
            },
            ...
            'social_security': {
                ...
                'age_62': request.POST.get('ss_age_62', ''),
                'desired_age': request.POST.get('ss_desired_age', ''),
                'benefit_desired': float(request.POST.get('ss_benefit_desired', 0) or 0),
                'benefit_62': float(request.POST.get('ss_benefit_62', 0) or 0),
                'collection_age': int(request.POST.get('ss_collection_age', 0) or 0) if request.POST.get('ss_collection_age') else None,
                'covered_employment': request.POST.get('ss_covered_employment', ''),
            ...
            'other_pension': {
                ...
                'pension_income': request.POST.get('pension_income', ''),
            ...
            'add_info': {
                ...
                'court_order_dividing_benefits': request.POST.get('court_order_dividing_benefits', ''),
                'reduce_spousal_pension': request.POST.get('reduce_spousal_pension', ''),
                'spouse_protection_reason': request.POST.get('spouse_protection_reason', ''),
                ...
                # Page 1 notes (from retirement/pay/leave section)
                'page1_notes': request.POST.get('retirement_pay_leave_notes', ''),
            },
            'mad': {
                'has_service': request.POST.get('active_duty') == 'on',
                'no_military_service': request.POST.get('no_military_service') == 'on',
                'no_special_service': request.POST.get('no_special_service') == 'on',
                ...
                'military_deposit': request.POST.get('military_deposit', ''),
                'amount_owed': request.POST.get('active_duty_owe_amount', ''),
                'military_owe': request.POST.get('military_owe', ''),
                'military_owe_amount': request.POST.get('military_owe_amount', ''),
                'military_owe_amount_check': request.POST.get('military_owe_amount_check', ''),
                'military_owe_zero': request.POST.get('military_owe_zero', ''),
            ...
            'reserves': {
                ...
                'reserve_credit': request.POST.get('reserve_credit', ''),
                ...
                'reserve_owe': request.POST.get('reserve_owe', ''),
                'reserve_owe_amount_check': request.POST.get('reserve_owe_amount_check', ''),
                'reserve_owe_zero': request.POST.get('reserve_owe_zero', ''),
            ...
            'fegli': {
                ...
                'five_year_requirement': 'Yes' if request.POST.get('fegli_5yr_yes') else ('No' if request.POST.get('fegli_5yr_no') else ('Unsure' if request.POST.get('fegli_5yr_unsure') else '')),
                'keep_in_retirement': 'Yes' if request.POST.get('fegli_keep_yes') else ('No' if request.POST.get('fegli_keep_no') else ('Unsure' if request.POST.get('fegli_keep_unsure') else '')),
                'sole_source': 'Yes' if request.POST.get('fegli_sole_yes') else ('No' if request.POST.get('fegli_sole_no') else ''),
            ...
            'fehb': {
                ...
                'five_year_requirement': 'Yes' if request.POST.get('fehb_health_5yr_yes') else ('No' if request.POST.get('fehb_health_5yr_no') else ('Unsure' if request.POST.get('fehb_health_5yr_unsure') else '')),
                'keep_in_retirement': 'Yes' if request.POST.get('fehb_keep_yes') else ('No' if request.POST.get('fehb_keep_no') else ('Unsure' if request.POST.get('fehb_keep_unsure') else '')),
                'spouse_reliant': 'Yes' if request.POST.get('fehb_spouse_yes') else ('No' if request.POST.get('fehb_spouse_no') else ('Unsure' if request.POST.get('fehb_spouse_unsure') else '')),
            ...
            'fltcip': {
                ...
                'discuss_options': 'Yes' if request.POST.get('fltcip_discuss_yes') else ('No' if request.POST.get('fltcip_discuss_no') else ('Unsure' if request.POST.get('fltcip_discuss_unsure') else '')),
        ...
        try:
            ...
            fff = FederalFactFinder.objects.create(
                ...
                has_active_duty='on' if request.POST.get('active_duty_yes') else None,
                ...
                active_duty_deposit_made='Yes' if request.POST.get('active_duty_deposit_yes') else ('No' if request.POST.get('active_duty_deposit_no') else ('Unsure' if request.POST.get('active_duty_deposit_unsure') else '')),
                active_duty_amount_owed=parse_decimal(request.POST.get('active_duty_owe_amount')),
                ...
                active_duty_lwop_deposit_made='Yes' if request.POST.get('lwop_deposit_yes') else ('No' if request.POST.get('lwop_deposit_no') else ('Unsure' if request.POST.get('lwop_deposit_unsure') else '')),
                active_duty_retired='on' if request.POST.get('retired_active_duty_yes') else None,
                ...
                # Military - Reserves
                has_reserves='on' if request.POST.get('reserve_yes') else None,
                ...
                reserves_deposit_made='Yes' if request.POST.get('reserve_deposit_yes') else ('No' if request.POST.get('reserve_deposit_no') else ('Unsure' if request.POST.get('reserve_deposit_unsure') else '')),
                ...
                reserves_lwop_deposit_made='Yes' if request.POST.get('reserve_lwop_deposit_yes') else ('No' if request.POST.get('reserve_lwop_deposit_no') else ('Unsure' if request.POST.get('reserve_lwop_deposit_unsure') else '')),
                reserves_retired='on' if request.POST.get('retired_reserves_yes') else None,
                ...
                # Military - Academy
                has_academy='on' if request.POST.get('academy_yes') else None,
                academy_start_date=parse_date(request.POST.get('academy_start')),
                academy_end_date=parse_date(request.POST.get('academy_end')),
                academy_deposit_made='Yes' if request.POST.get('academy_deposit_yes') else ('No' if request.POST.get('academy_deposit_no') else ('Unsure' if request.POST.get('academy_deposit_unsure') else '')),
                academy_amount_owed=parse_decimal(request.POST.get('academy_owe_amount')),
                academy_in_leave_scd='Yes' if request.POST.get('academy_scd_yes') else ('No' if request.POST.get('academy_scd_no') else ('Unsure' if request.POST.get('academy_scd_unsure') else '')),
                academy_notes=request.POST.get('military_academy_notes', ''),
                
                # Non-Deduction Service
                has_non_deduction_service='on' if request.POST.get('non_deduction_yes') else None,
                ...
                non_deduction_deposit_made='Yes' if request.POST.get('non_deduction_deposit_yes') else ('No' if request.POST.get('non_deduction_deposit_no') else ('Unsure' if request.POST.get('non_deduction_deposit_unsure') else '')),
                ...
                # Break-in-Service
                has_break_in_service='on' if request.POST.get('break_service_yes') else None,
                ...
                break_took_refund='Yes' if request.POST.get('refund_yes') else ('No' if request.POST.get('refund_no') else ('Unsure' if request.POST.get('refund_unsure') else '')),
                break_redeposit_made='Yes' if request.POST.get('redeposit_yes') else ('No' if request.POST.get('redeposit_no') else ('Unsure' if request.POST.get('redeposit_unsure') else '')),
                ...
                # Part-Time Service
                has_part_time_service='on' if request.POST.get('part_time_yes') else None,
                ...
                part_time_contributed_to_retirement='Yes' if request.POST.get('part_time_contributed_yes') else ('No' if request.POST.get('part_time_contributed_no') else ('Unsure' if request.POST.get('part_time_contributed_unsure') else '')),
                ...
                fegli_coverage_5_year_requirement='Yes' if request.POST.get('fegli_5yr_yes') else ('No' if request.POST.get('fegli_5yr_no') else ('Unsure' if request.POST.get('fegli_5yr_unsure') else '')),
                fegli_keep_coverage_in_retirement='Yes' if request.POST.get('fegli_keep_yes') else ('No' if request.POST.get('fegli_keep_no') else ('Unsure' if request.POST.get('fegli_keep_unsure') else '')),
                fegli_sole_source_life_insurance='Yes' if request.POST.get('fegli_sole_yes') else ('No' if request.POST.get('fegli_sole_no') else ''),
                ...
                fehb_health_5_year_requirement='Yes' if request.POST.get('fehb_health_5yr_yes') else ('No' if request.POST.get('fehb_health_5yr_no') else ('Unsure' if request.POST.get('fehb_health_5yr_unsure') else '')),
                fehb_keep_coverage_in_retirement='Yes' if request.POST.get('fehb_keep_yes') else ('No' if request.POST.get('fehb_keep_no') else ('Unsure' if request.POST.get('fehb_keep_unsure') else '')),
                fehb_spouse_reliant_on_plan='Yes' if request.POST.get('fehb_spouse_yes') else ('No' if request.POST.get('fehb_spouse_no') else ('Unsure' if request.POST.get('fehb_spouse_unsure') else '')),
                ...
                fltcip_discuss_options='Yes' if request.POST.get('fltcip_discuss_yes') else ('No' if request.POST.get('fltcip_discuss_no') else ('Unsure' if request.POST.get('fltcip_discuss_unsure') else '')),
                ...
                tsp_amount_needed=parse_decimal(request.POST.get('tsp_amount_needed')),
                ...
                tsp_sole_source_investing='Yes' if request.POST.get('tsp_sole_yes') else ('No' if request.POST.get('tsp_sole_no') else ''),
                tsp_sole_source_explain=request.POST.get('tsp_sole_source_explain', ''),
                ...
                tsp_in_service_withdrawal='Yes' if request.POST.get('tsp_withdrawal_yes') else ('No' if request.POST.get('tsp_withdrawal_no') else ''),
                ...
                tsp_general_loan_balance=parse_decimal(request.POST.get('tsp_general_loan_balance')),
                tsp_general_loan_repayment=parse_decimal(request.POST.get('tsp_general_loan_repayment')),
                tsp_general_loan_payoff_date=parse_date(request.POST.get('tsp_general_loan_payoff')),
                tsp_residential_loan_date=parse_date(request.POST.get('tsp_residential_loan_date')),
                tsp_residential_loan_balance=parse_decimal(request.POST.get('tsp_residential_loan_balance')),
                tsp_residential_loan_repayment=parse_decimal(request.POST.get('tsp_residential_loan_repayment')),
                tsp_residential_loan_payoff_date=parse_date(request.POST.get('tsp_residential_loan_payoff')),
                
                # TSP Fund Balances
                tsp_g_fund_balance=parse_decimal(request.POST.get('tsp_g_fund_balance')),
                tsp_f_fund_balance=parse_decimal(request.POST.get('tsp_f_fund_balance')),
                tsp_c_fund_balance=parse_decimal(request.POST.get('tsp_c_fund_balance')),
                tsp_s_fund_balance=parse_decimal(request.POST.get('tsp_s_fund_balance')),
                tsp_i_fund_balance=parse_decimal(request.POST.get('tsp_i_fund_balance')),
                ...
                tsp_l_2030_balance=parse_decimal(request.POST.get('tsp_l_2030_balance')),
                tsp_l_2035_balance=parse_decimal(request.POST.get('tsp_l_2035_balance')),
                tsp_l_2040_balance=parse_decimal(request.POST.get('tsp_l_2040_balance')),
                tsp_l_2045_balance=parse_decimal(request.POST.get('tsp_l_2045_balance')),
                tsp_l_2050_balance=parse_decimal(request.POST.get('tsp_l_2050_balance')),
                tsp_l_2055_balance=parse_decimal(request.POST.get('tsp_l_2055_balance')),
                tsp_l_2060_balance=parse_decimal(request.POST.get('tsp_l_2060_balance')),
                ...
                tsp_f_fund_allocation=parse_decimal(request.POST.get('tsp_f_fund_allocation')),
                tsp_c_fund_allocation=parse_decimal(request.POST.get('tsp_c_fund_allocation')),
                tsp_s_fund_allocation=parse_decimal(request.POST.get('tsp_s_fund_allocation')),
                tsp_i_fund_allocation=parse_decimal(request.POST.get('tsp_i_fund_allocation')),
                tsp_l_income_allocation=parse_decimal(request.POST.get('tsp_l_income_allocation')),
                tsp_l_2025_allocation=parse_decimal(request.POST.get('tsp_l_2025_allocation')),
                tsp_l_2030_allocation=parse_decimal(request.POST.get('tsp_l_2030_allocation')),
                tsp_l_2035_allocation=parse_decimal(request.POST.get('tsp_l_2035_allocation')),
                tsp_l_2040_allocation=parse_decimal(request.POST.get('tsp_l_2040_allocation')),
                tsp_l_2045_allocation=parse_decimal(request.POST.get('tsp_l_2045_allocation')),
                tsp_l_2050_allocation=parse_decimal(request.POST.get('tsp_l_2050_allocation')),
                tsp_l_2055_allocation=parse_decimal(request.POST.get('tsp_l_2055_allocation')),
                tsp_l_2060_allocation=parse_decimal(request.POST.get('tsp_l_2060_allocation')),
                ...
                tsp_comments='\n\n'.join(filter(None, [
                    f"Risk Tolerance Why: {request.POST.get('tsp_risk_tolerance_why', '')}" if request.POST.get('tsp_risk_tolerance_why', '') else '',
            ...
            # FederalFactFinder model has field mismatches - PDF uses fact_finder_data JSON anyway
            logger.warning(f"FederalFactFinder save skipped for case {case.id}: {str(e)[:100]}")
