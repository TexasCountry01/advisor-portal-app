    ...
    if request.method == 'POST':
        ...
        fact_finder_data = {
            ...
            'tsp': {
                ...
                'retirement_goal': request.POST.get('tsp_goal_amount', ''),
                'amount_needed': request.POST.get('tsp_need_amount', ''),
                ...
                'sole_source_explain': request.POST.get('tsp_sole_explain', ''),
                ...
                'traditional_contribution': request.POST.get('tsp_traditional_contributions', ''),
                'roth_contribution': request.POST.get('tsp_roth_contributions', ''),
                'best_result': request.POST.get('tsp_best_result', ''),
                'worst_result': request.POST.get('tsp_worst_result', ''),
                'comments': request.POST.get('tsp_comments', ''),
                # TSP fund allocations and balances
                'g_allocation': float(request.POST.get('tsp_g_allocation', 0) or 0),
                'g_balance': float(request.POST.get('tsp_g_balance', 0) or 0),
                'f_allocation': float(request.POST.get('tsp_f_allocation', 0) or 0),
                'f_balance': float(request.POST.get('tsp_f_balance', 0) or 0),
                'c_allocation': float(request.POST.get('tsp_c_allocation', 0) or 0),
                'c_balance': float(request.POST.get('tsp_c_balance', 0) or 0),
                's_allocation': float(request.POST.get('tsp_s_allocation', 0) or 0),
                's_balance': float(request.POST.get('tsp_s_balance', 0) or 0),
                'i_allocation': float(request.POST.get('tsp_i_allocation', 0) or 0),
                'i_balance': float(request.POST.get('tsp_i_balance', 0) or 0),
                ...
                'l2025_allocation': float(request.POST.get('tsp_l2025_allocation', 0) or 0),
                'l2025_balance': float(request.POST.get('tsp_l2025_balance', 0) or 0),
                'l2030_allocation': float(request.POST.get('tsp_l2030_allocation', 0) or 0),
                'l2030_balance': float(request.POST.get('tsp_l2030_balance', 0) or 0),
                'l2035_allocation': float(request.POST.get('tsp_l2035_allocation', 0) or 0),
                'l2035_balance': float(request.POST.get('tsp_l2035_balance', 0) or 0),
                'l2040_allocation': float(request.POST.get('tsp_l2040_allocation', 0) or 0),
                'l2040_balance': float(request.POST.get('tsp_l2040_balance', 0) or 0),
                'l2045_allocation': float(request.POST.get('tsp_l2045_allocation', 0) or 0),
                'l2045_balance': float(request.POST.get('tsp_l2045_balance', 0) or 0),
                'l2050_allocation': float(request.POST.get('tsp_l2050_allocation', 0) or 0),
                'l2050_balance': float(request.POST.get('tsp_l2050_balance', 0) or 0),
                'l2055_allocation': float(request.POST.get('tsp_l2055_allocation', 0) or 0),
                'l2055_balance': float(request.POST.get('tsp_l2055_balance', 0) or 0),
                'l2060_allocation': float(request.POST.get('tsp_l2060_allocation', 0) or 0),
                'l2060_balance': float(request.POST.get('tsp_l2060_balance', 0) or 0),
                'l2065_70_allocation': float(request.POST.get('tsp_l2065_70_allocation', 0) or 0),
                'l2065_70_balance': float(request.POST.get('tsp_l2065_70_balance', 0) or 0),
                # TSP loan details
                'loan_general_balance': float(request.POST.get('tsp_loan_general_balance', 0) or 0),
                'loan_general_date': request.POST.get('tsp_loan_general_date', ''),
                'loan_general_payoff_date': request.POST.get('tsp_loan_general_payoff_date', ''),
                'loan_general_repayment': float(request.POST.get('tsp_loan_general_repayment', 0) or 0),
                'loan_residential_balance': float(request.POST.get('tsp_loan_residential_balance', 0) or 0),
                'loan_residential_date': request.POST.get('tsp_loan_residential_date', ''),
                'loan_residential_payoff_date': request.POST.get('tsp_loan_residential_payoff_date', ''),
                'loan_residential_repayment': float(request.POST.get('tsp_loan_residential_repayment', 0) or 0),
                # Risk tolerance
                'risk_tolerance_employee': request.POST.get('risk_tolerance_employee', ''),
                'risk_tolerance_spouse': request.POST.get('risk_tolerance_spouse', ''),
                'risk_tolerance_why': request.POST.get('risk_tolerance_why', ''),
            },
