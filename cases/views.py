    ...
    if request.method == 'POST':
        ...
        fact_finder_data = {
            ...
            'tsp': {
                ...
                'sole_source': request.POST.get('tsp_sole_source', ''),
                ...
                'in_service_withdrawal': request.POST.get('tsp_in_service_withdrawal', ''),
            ...
            'add_info': {
                ...
                'additional_notes_final': request.POST.get('additional_notes_final', ''),
